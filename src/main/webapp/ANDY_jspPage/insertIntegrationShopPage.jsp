...
<body>
        <form id="insertIntegrationShop-form">
            商品名称：<input type="text" name="shopname"><br/>
            封面图片：<input type="file" id="IntegrationUpload"/>
            <input type="hidden" id="Integrationscoverfile" name="shopimg">
            <div id="IntegrationFileQueue"></div>
            <div id="IntegrationShow"></div><br/>
            所需积分：<input type="text" name="needintegra"><br/>
            添加库存数量：<input type="text" name="shopcount">
        </form>

<script>
    $("#IntegrationUpload").uploadify({
        //插件自带  不可忽略的参数
        ...
        'onUploadSuccess' : function(file, data, response) {
            $("#Integrationscoverfile").val(data);
            var html = '<img  src='+data+' width="50" height="50">';
            $("#IntegrationShow").html(html);
        }
    })
</script>
</body>
